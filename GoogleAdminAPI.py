...
GET_LATEST_ALUMNI_OU_LIST = "/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh print users query " \
                            "orgUnitPath='/Alumni' > AlumniOU_new.txt"
GET_ALUMNI_OU_LIST_FROM_DRIVE = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh user ' \
                                'admin-alishev get ' \
                                'drivefile id 1HNF9-wh7Mawgab5FSL5crMqU1FfGI8PDZx7_bIPx-ZA format txt targetfolder ' \
                                '/app/ '
INITIATE_MAIL_EXPORT = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh create export matter Test corpus mail ' \
                       'name "{}" accounts {}'
INITIATE_DRIVE_EXPORT = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh create export matter Test corpus drive ' \
                        'name "{}" accounts {}'
GET_EXPORT_STATUS = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh info export Test "{}" | grep status:'
DOWNLOAD_EXPORT = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh download export Test {} targetfolder /tmp/'
UPLOAD_EXPORT = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh user admin-alishev add drivefile ' \
                'localfile /tmp/{} parentid 0AOOb5eIIkqg5Uk9PVA '
EXPORT_COMPLETE_MESSAGE = " status: COMPLETED"
UPDATE_DRIVE_FILE = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh user admin-alishev update drivefile id ' \
                    '1HNF9-wh7Mawgab5FSL5crMqU1FfGI8PDZx7_bIPx-ZA localfile AlumniOU_new.txt newfilename AlumniOU.txt'
CREATE_FOLDER_IN_DRIVE = '/Users/azamat.alishev/bin/docker-gamad-local/gamad.sh user admin-alishev create drivefile ' \
